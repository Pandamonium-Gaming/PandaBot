...
/// the observability stack can scrape bot health gauges without needing
/// direct access to the bot's SQLite database.
/// </summary>
internal sealed class MetricsHostedService : BackgroundService
{
    ...
    {
        _port = configuration.GetValue<int>("Metrics:Port", 9093);
        _logger = logger;
    }
