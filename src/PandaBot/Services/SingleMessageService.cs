...
public class SingleMessageService
{
    ...
    private async Task<bool> EnsureSchemaInitializedAsync(PandaBotContext db)
    {
    ...
    private static async Task<bool> TableExistsAsync(PandaBotContext db, string tableName)
    {
    ...
    private static async Task<bool> TableColumnExistsAsync(PandaBotContext db, string tableName, string columnName)
    {
        var connection = db.Database.GetDbConnection();
        var closeWhenDone = connection.State != System.Data.ConnectionState.Open;
    ...
    private static async Task EnsureColumnExistsAsync(PandaBotContext db, string tableName, string columnName, string sqlTypeDefinition)
    {
    ...
    private static async Task CreateMissingSingleMessageSchemaAsync(PandaBotContext db)
    {
